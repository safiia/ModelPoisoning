...
def data_mnist(one_hot=True):
    ...
    if gv.args.dataset == 'MNIST':
        ...
        X_train, y_train = load_fmnist('./kaggle/input/fashon-mnist-train-and-test-data', kind='train')
        X_test, y_test = load_fmnist('./kaggle/input/fashon-mnist-train-and-test-data', kind='t10k')
